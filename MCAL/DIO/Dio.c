...
DIO_ValueType DIO_GetPinValue(DIO_PrephieralType* port, DIO_PinType pin)
{
    ...
    {
    case DIO_PIN0:
        value = port->pin.BIT.B0;
        break;
    
    case DIO_PIN1:
    value = port->pin.BIT.B1;
        break;
    
    case DIO_PIN2:
    value = port->pin.BIT.B2;
        break;
    
    case DIO_PIN3:
    value = port->pin.BIT.B3;
        break;
    
    case DIO_PIN4:
    value = port->pin.BIT.B4;
        break;
    
    case DIO_PIN5:
    value = port->pin.BIT.B5;
        break;
    
    case DIO_PIN6:
    value = port->pin.BIT.B6;
        break;
    
    case DIO_PIN7:
    value = port->pin.BIT.B7;
        break;
